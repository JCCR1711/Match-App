...
const VenueSelectorItem = ({ index, name, fieldCount, selected, onPress }: VenueSelectorItemProps) => (
  ...
  >
    <CustomText text={String(index + 1).padStart(2, "0")} variant="actionSecondary" style={[styles.index, selected && styles.selectedMuted]} />
...
const styles = StyleSheet.create({
  item: { width: 148, minHeight: 64, flexDirection: "row", alignItems: "center", gap: theme.spacing.sm, paddingHorizontal: theme.spacing.md, borderRadius: theme.radius.pill, backgroundColor: theme.colors.surfaceOnDarkSubtle },
